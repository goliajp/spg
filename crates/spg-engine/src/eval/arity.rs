...
pub(crate) static REFUSED_ARITIES: &[(&str, &[usize])] = &[
    ...
    ("adddate", &[0, 1, 3, 4, 5, 6, 7, 8]),
    ("addtime", &[0, 1, 3, 4, 5, 6, 7, 8]),
    ...
    ("date_add", &[0, 1, 3, 4, 5, 6, 7, 8]),
    ("date_bin", &[0, 1, 2, 4, 5, 6, 7, 8]),
    ("date_sub", &[0, 1, 3, 4, 5, 6, 7, 8]),
    ("date_subtract", &[0, 1, 3, 4, 5, 6, 7, 8]),
    ("datediff", &[0, 1, 3, 4, 5, 6, 7, 8]),
    ("daterange", &[0, 1, 4, 5, 6, 7, 8]),
    ("day", &[0, 3, 4, 5, 6, 7, 8]),
    ("dayname", &[0, 2, 3, 4, 5, 6, 7, 8]),
    ("dayofmonth", &[0, 3, 4, 5, 6, 7, 8]),
    ("dayofweek", &[0, 2, 3, 4, 5, 6, 7, 8]),
    ("dayofyear", &[0, 2, 3, 4, 5, 6, 7, 8]),
    ...
    ("md5", &[0, 2, 3, 4, 5, 6, 7, 8]),
    ("microsecond", &[0, 2, 3, 4, 5, 6, 7, 8]),
    ("mid", &[0, 1, 4, 5, 6, 7, 8]),
    ("min_scale", &[0, 2, 3, 4, 5, 6, 7, 8]),
    ("minute", &[0, 2, 3, 4, 5, 6, 7, 8]),
    ("mod", &[0, 1, 3, 4, 5, 6, 7, 8]),
    ("month", &[0, 3, 4, 5, 6, 7, 8]),
    ("monthname", &[0, 2, 3, 4, 5, 6, 7, 8]),
