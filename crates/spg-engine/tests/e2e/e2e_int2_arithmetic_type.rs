...
fn int2_arithmetic_stays_int2() {
    ...
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 + 3::int2)::text"), "smallint");
    assert_eq!(one(&mut e, "SELECT (5::int2 + 3::int2)::text"), "8");
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 - 9::int2)::text"), "smallint");
    assert_eq!(one(&mut e, "SELECT (5::int2 - 9::int2)::text"), "-4");
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 * 4::int2)::text"), "smallint");
    assert_eq!(one(&mut e, "SELECT pg_typeof(7::int2 / 2::int2)::text"), "smallint");
    assert_eq!(one(&mut e, "SELECT (7::int2 / 2::int2)::text"), "3");
    assert_eq!(one(&mut e, "SELECT pg_typeof(7::int2 % 3::int2)::text"), "smallint");
}
...
fn int2_bitwise_and_shift_stay_int2() {
    ...
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 | 2::int2)::text"), "smallint");
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 # 1::int2)::text"), "smallint");
    assert_eq!(one(&mut e, "SELECT pg_typeof(~(5::int2))::text"), "smallint");
    assert_eq!(one(&mut e, "SELECT (~(5::int2))::text"), "-6");
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 << 1)::text"), "smallint");
...
fn int2_widens_only_when_mixed() {
    let mut e = Engine::new();
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 + 3::int4)::text"), "integer");
    assert_eq!(one(&mut e, "SELECT pg_typeof(5::int2 + 3::int8)::text"), "bigint");
}
