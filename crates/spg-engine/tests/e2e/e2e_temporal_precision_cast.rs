...
fn time_and_timestamp_precision_casts() {
    ...
    let cases = [
        ...
        ("('2024-06-15 12:34:56.789012'::timestamp(2))::text", "2024-06-15 12:34:56.79"),
        ("('2024-06-15 12:34:56.789012'::timestamp(0))::text", "2024-06-15 12:34:57"),
        ("('2024-06-15 12:34:56.789'::timestamptz(0))::text", "2024-06-15 12:34:57"),
