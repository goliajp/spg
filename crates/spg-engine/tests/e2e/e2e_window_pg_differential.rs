...
fn frames() {
    ...
    ck(&mut e, "avg(x) OVER (ORDER BY id ROWS BETWEEN 1 PRECEDING AND 1 FOLLOWING)", "15.0000000000000000|16.6666666666666667|20.0000000000000000|25.0000000000000000|35.0000000000000000|40.0000000000000000|45.0000000000000000");
...
fn aggregates_as_window() {
    ...
    ck(&mut e, "avg(x) OVER (PARTITION BY g)", "16.6666666666666667|16.6666666666666667|16.6666666666666667|16.6666666666666667|35.0000000000000000|35.0000000000000000|50.0000000000000000");  // live-PG18.4-exact numeric
