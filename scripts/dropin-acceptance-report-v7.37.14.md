...
| `round20.aggregate_group_composite` | ❌ | ERROR: cannot convert text to FLOAT |
...
```bash
scripts/dropin-acceptance.sh --image goliakk/spg:7.37.14 --port 25433
```
