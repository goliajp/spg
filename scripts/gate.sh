...
run_gates() {
    ...
    for target in uniq_prune_counters uniq_composite_probe pred_int_lane_counters uniq_collated_probe_903 composite_eq_probe_903 rebase_keeps_index_904; do
